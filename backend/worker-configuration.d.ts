/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9e2ed2a976d5f507ea54b5fddb8efe63)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CORS_ORIGINS" | "JWT_SECRET">> {}
}
